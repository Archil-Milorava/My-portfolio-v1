...
function TechStack() {
  return (
    ...
    className="font-baskervville text-green-main  h-[572px] w-[526px] bg-[url(../assets/bg2.png)] bg-cover shadow-lg border border-green-main border-opacity-20 p-16 overflow-hidden">
